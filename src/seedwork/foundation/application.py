...
from seedwork.foundation.application_module import ApplicationModule
from seedwork.foundation.dependency_provider import BasicDependencyProvider, DependencyProvider
from seedwork.foundation.message import Event, Message
from seedwork.foundation.transaction_context import (
    ComposerFunction,
    MessageHandler,
    MiddlewareFunction,
...
from seedwork.foundation.types import DependencyIdentifier
...
class Application(ApplicationModule):
    ...
    def compose(self, alias):
        ...
        **Example:**
        ...
        >>> from seedwork.foundation import Application, Command, TransactionContext
