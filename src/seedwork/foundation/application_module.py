...
from seedwork.foundation.transaction_context import MessageHandler
from seedwork.foundation.types import HandlerAlias
from seedwork.foundation.utils import OrderedSet, string_to_kwarg_name
...
class ApplicationModule:
    ...
    def handler(self, alias: HandlerAlias) -> Callable:
        ...
        :param alias: :class:`seedwork.foundation.Message` or a string.

        Example #1:
        -----------
        >>> from seedwork.foundation import Application, ApplicationModule
        ...
        Example #2:
        -----------
        >>> from seedwork.foundation import ApplicationModule, Command
